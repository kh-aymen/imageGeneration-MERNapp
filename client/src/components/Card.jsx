      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div className='w-7 h-7 rounded-full flex object-cover bg-green-700 justify-center items-center text-white text-xs font-bold'>
              {name[0]}
            </div>
          ...
          <button type="button" onClick={() => downloadImage(_id, photo)}
            ...
            <img src={download} alt='download button' className='w-6 h-6 object-cover invert' />
          </button>
        </div>
      </div>
    </div>
